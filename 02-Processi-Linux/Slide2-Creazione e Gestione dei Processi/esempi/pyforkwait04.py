#!/usr/bin/env python3
"""
pyforkwait04.py - © FB - 7/12/20 -> 26/11/25

Esempio di utilizzo istruzione wait con un processo figlio e terminazione involontaria.
...
def child_process():
    ...
    a = 0
    a = 10 / a  # Errore! ZeroDivisionError
    sys.exit(100)
